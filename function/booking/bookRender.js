...
export function renderBooking(user, response) {
  if (response.data == null) {
    ...
    let attractionImage = document.querySelector(
      ".reservebar--bookinginfo--img"
    );
    let bookingTitle = document.querySelector(
      ".reservebar--bookinginfo--details--titlerow--title"
    );
    let bookingDate = document.querySelector(
      "#reservebar--bookinginfo--details--contentrow--date"
    );
    let bookingTime = document.querySelector(
      "#reservebar--bookinginfo--details--contentrow--time"
    );
    let bookingPrice = document.querySelector(
      "#reservebar--bookinginfo--details--contentrow--price"
    );
    let bookingAddress = document.querySelector(
      "#reservebar--bookinginfo--details--contentrow--address"
    );
