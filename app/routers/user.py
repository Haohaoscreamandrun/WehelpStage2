...
from app.function.function import fetchJSON, commitDB
from app.function.basemodel import UserSignUPInput, UserSignInInput, ReturnUser
...
async def sign_up(user: UserSignUPInput):
    ...
    # Cond2: Email exist
        ...
        response = {"error": True, "message": "電子郵件已被註冊"}
    ...
    # Cond2: user exist
        ...
        try:
            ...
            for user_critical in myresult:
                ...
                # Encode info
                encoded_response = jwt.encode(response, JWTkey, algorithm="HS256")
                # Construct response
                response = {"token": encoded_response}
                return JSONResponse(status_code=200, content=response)
